...
* uma empresa de comercio atacadista                     *
* Data - 07/03/2025                                      * 
...
//encontrar a posicao de um produto no estoque
...
void estocar_produto(char estoque[RUAS][GONDOLAS][PRODUTOS][5], char codigo[5]) {
    ...
    printf("Nao ha espaço disponível no estoque.\n");
}
...
int main() {
    //matriz para armazenar os produtos
